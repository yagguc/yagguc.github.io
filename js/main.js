$("#pubButton").click(function(){
  if ($("#pubButton").text() == "Click here to show all publications.") {
      bibtexify("biblist.bib", "pubTable");
      $("#pubButton").text("Hide publications.")
  } else { 
    $(".dataTables_wrapper").toggle("slow");
    $("#pubTablepubchart").toggle("slow");
    $(".legend").toggle("slow");
    if ($("#pubButton").text() == "Hide publications.") {
      $("#pubButton").text("Show publications.")
    } else {
      $("#pubButton").text("Hide publications.")
    }
  } 
